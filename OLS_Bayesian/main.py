...
if __name__ == "__main__":
    ...
    for lambda_val in lambda_val_lst:
        ...
        var_P = inference(theta_0_array, P_X, X, Y, lambda_val, max_iterations= n, alpha= 0.5, learning_rate=0.01)
        var_P_lst.append(var_P)
        var_U = inference(theta_0_array, U_X, X, Y, lambda_val, max_iterations= n, alpha= 0.5, learning_rate=0.01)
...
plt.ylabel('Variance')
plt.title("Variance vs lambda value (d=100, n=50, initial_sample ="+ str(initial_ite)+ ")")
plt.legend()
